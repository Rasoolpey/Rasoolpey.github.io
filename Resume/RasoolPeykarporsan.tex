...
\section{REFERENCES}
 \begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
     \textbf{Dr. [Supervisor Name]} $|$ \textit{PhD Supervisor, Auckland University of Technology} \\
     \href{mailto:email@aut.ac.nz}{\myuline{email@aut.ac.nz}} \hspace{2pt} $|$ \hspace{2pt} \texttt{+64 [Phone Number]} \vspace{4pt} \\
     \textbf{[Friend / Colleague Name]} $|$ \textit{[Job Title], [Company / University]} \\
     \href{mailto:email@domain.com}{\myuline{email@domain.com}} \hspace{2pt} $|$ \hspace{2pt} \texttt{+64 [Phone Number]}
    }}
 \end{itemize}
